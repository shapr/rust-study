  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            rust_study = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        rust_study-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        rust_study-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        rust_study-audit = craneLib.cargoAudit {
      ...
      packages = forAllSystems ({ rust_study, ... }: {
        inherit rust_study;
        default = rust_study;
      });
      ...
      apps = forAllSystems ({system, ...}: {
        rust_study = {
          type = "app";
          program = "${self.packages.${system}.rust_study}/bin/rust_study";
        };
        default = self.apps.${system}.rust_study;
      });
